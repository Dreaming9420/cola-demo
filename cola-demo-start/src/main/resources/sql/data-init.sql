-- 插入商品表数据
INSERT INTO item (id, item_name, introduction, sale_price, create_time, update_time)
...
-- 插入订单表数据
INSERT INTO `order` (id, user_id, order_no, create_time, update_time)
...
-- 插入订单商品表数据
INSERT INTO order_item (id, order_id, order_no, item_id, item_name, item_price, quantity, create_time, update_time)
